...
Использование подобной разметки может помочь решить некоторые
[проблемы с экспортом информации][syndication-problem]: в RSS можно
отдавать необработанный размеченный Markdown'ом текст — это и не
ухудшит сильно читаемость ленты, и будет совместимо со всеми
программами для чтения RSS.
...
подключенного к шаблонному движку Django][django-filter]) и других
языков, ссылки можно найти в [статье про Markdown на Википедии][].
...
на Википедии][light-markup-wiki].
  ...
  [syndication-problem]: http://forum.sysman.ru/index.php?showtopic=7578
  ...
  [django-filter]: http://code.djangoproject.com/browser/django/trunk/django/contrib/markup/templatetags/markup.py
  ...
  [light-markup-wiki]: http://en.wikipedia.org/wiki/List_of_lightweight_markup_languages
